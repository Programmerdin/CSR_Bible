    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-indigo-100 px-4 relative">
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollAreaNoBar className="h-[calc(100vh)] hideScrollbar">
          <h1 className="text-4xl font-bold text-indigo-900 mb-8 mt-12 text-center">Deposit USD Cash to USD Account</h1>
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="space-y-6">
                <div className="text-lg text-indigo-700">
                  <img src={i1} alt="CBFE Step" className="rounded-lg object-cover w-full shadow-lg mb-4" />
                  <p className="mt-2">Print out Branch Copy</p>
                </div>

                <div className="text-lg text-indigo-700">
                  <img src={i3} alt="Rate Information" className="rounded-lg object-cover w-full shadow-lg mb-4" />
                  <p className="mt-2">Rate listed on the Branch Copy will be used on COINS</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="text-lg text-indigo-700">
                  <img src={i2} alt="COINS Entry" className="rounded-lg object-cover w-full shadow-lg mb-4" />
                  <ul className="space-y-2">
                    <li>CURRENCY: USD</li>
                    <li>FOREIGN AMOUNT: Amount deposited in USD</li>
                    <li>DEBIT/CREDIT (DR/CR): CR</li>
                    <li>COUNTER RATE: Rate listed on the Branch Copy</li>
                    <li>FOREIGN CURR TR/ACCT: type in client's USD account info</li>
